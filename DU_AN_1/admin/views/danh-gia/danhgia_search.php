...
switch ($status) {
  ...
  <div id="pagination">
    <ul>
        <!-- First Page Button -->
        <li>
            <a href="index.php?page=comment&pagedg=1" class="<?php echo ($page == 1) ? 'active' : ''; ?>">First</a>
        </li>

        <!-- Previous Page Button -->
        <li>
            <a href="index.php?page=comment&pagedg=<?php echo ($page > 1) ? $page - 1 : 1; ?>" class="<?php echo ($page == 1) ? 'disabled' : ''; ?>">Prev</a>
        </li>
        ...
        <!-- Next Page Button -->
        <li>
            <a href="index.php?page=comment&pagedg=<?php echo ($page < $sotrang) ? $page + 1 : $sotrang; ?>" class="<?php echo ($page == $sotrang) ? 'disabled' : ''; ?>">Next</a>
        </li>

        <!-- Last Page Button -->
        <li>
            <a href="index.php?page=comment&pagedg=<?php echo $sotrang; ?>" class="<?php echo ($page == $sotrang) ? 'active' : ''; ?>">Last</a>
        </li>
    </ul>
</div>
