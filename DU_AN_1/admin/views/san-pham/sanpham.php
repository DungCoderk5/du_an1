...
<div class="main-content">
    ...
    <div class="content">
        <div class="search_content">
            <button class="btn">
                <a href="index.php?page=product&action=addsanpham">Thêm Sản Phẩm</a>
            </button>
            <div class="search">
        ...
        <div id="pagination">
            <ul>
                <!-- First Page Button -->
                <li>
                    <a href="index.php?page=product&pagepr=1"
                        class="<?php echo ($page == 1) ? 'active' : ''; ?>">First</a>
                </li>

                <!-- Previous Page Button -->
                <li>
                    <a href="index.php?page=product&pagepr=<?php echo ($page > 1) ? $page - 1 : 1; ?>"
                ...
                <li>
                    <a href="index.php?page=product&pagepr=<?php echo $i; ?>"
                ...
                <!-- Next Page Button -->
                <li>
                    <a href="index.php?page=product&pagepr=<?php echo ($page < $sotrang) ? $page + 1 : $sotrang; ?>"
                        class="<?php echo ($page == $sotrang) ? 'disabled' : ''; ?>">Next</a>
                </li>

                <!-- Last Page Button -->
                <li>
                    <a href="index.php?page=product&pagepr=<?php echo $sotrang; ?>"
