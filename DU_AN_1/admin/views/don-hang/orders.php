    ...
    <div class="content">
        ...
        <div id="pagination">
            <ul>
                <!-- First Page Button -->
                <li>
                    <a href="index.php?page=orders&pagedh=1"
                        class="<?php echo ($page == 1) ? 'active' : ''; ?>">First</a>
                </li>

                <!-- Previous Page Button -->
                <li>
                    <a href="index.php?page=orders&pagedh=<?php echo ($page > 1) ? $page - 1 : 1; ?>"
                ...
                <?php for ($i = 1; $i <= $sotrang; $i++): ?>
                    <li>
                        <a href="index.php?page=orders&pagedh=<?php echo $i; ?>"
                ...
                <!-- Next Page Button -->
                <li>
                    <a href="index.php?page=orders&pagedh=<?php echo ($page < $sotrang) ? $page + 1 : $sotrang; ?>"
                        class="<?php echo ($page == $sotrang) ? 'disabled' : ''; ?>">Next</a>
                </li>

                <!-- Last Page Button -->
                <li>
                    <a href="index.php?page=orders&pagedh=<?php echo $sotrang; ?>"
